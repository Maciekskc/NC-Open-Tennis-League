...
namespace Persistance.Migrations
{
    ...
    [Migration("20230119211637_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Persistance.Models.Game", b =>
                {
                    b.HasOne("Persistance.Models.ApplicationUser", "ChellangedPlayer")
                        .WithMany("ChellangedGames")
                        .HasForeignKey("ChellangedPlayerId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Persistance.Models.ApplicationUser", "ChellengingPlayer")
            ...
            modelBuilder.Entity("Persistance.Models.LeaguePositions", b =>
                {
                    ...
                    b.HasOne("Persistance.Models.ApplicationUser", "Player")
                        .WithMany("Positions")
